...
density = sw.density_estimator(data)
...
def test_simulate_dataset():
    ...
    # No parameters
    test_parameter_values(func=sw.simulate_dataset)

    # name
    test_parameter_values(
        func=sw.simulate_dataset,
        var_name='name',
        fail_list=[
            None,
            1,
        ...
        success_list=sw.list_simulated_densities()
    )
...
def test_list_simulated_densities():
    """
    Test list_simulated_densities()
    """

    # No parameters
    test_parameter_values(func=sw.list_simulated_densities)
...
def test_ExampleDataset___init__():
    ...
    # No parameters
    test_parameter_values(func=sw.example_dataset)

    # dataset
    test_parameter_values(
        func=sw.example_dataset,
        var_name='dataset',
        fail_list=[
            None,
            1,
        ...
        success_list=sw.list_example_datasets()
    )
...
def test_list_example_datasets():
    ...
    """
    # No parameters
    test_parameter_values(func=sw.list_example_datasets)
...
def test_DensityEstimator_evaluate_samples():
    ...
    test_parameter_values(
        ...
        success_list=[
            ...
            np.random.randn(10),
            np.random.randn(3, 3),
            np.asmatrix(range(10)),
            np.asmatrix(range(10)).T,
...
def test_DensityEstimator___init__():
    ...
    test_parameter_values(
        ...
        success_list=[
            ...
            np.asmatrix(np.linspace(-3, 3, 100)),
            np.asmatrix(np.linspace(-3, 3, 100).T),
...
if __name__ == '__main__':
    ...
    test_list_example_datasets()

    # simulate_dataset
    test_simulate_dataset()
    
    # list_simulated_densities
    test_list_simulated_densities()
